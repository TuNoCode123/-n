...
async function submitCreatCategory() {
...
<template>
  <form class="w-full max-w-md mx-auto">
    ...
    <div class="grid md:grid-cols-1 md:gap-6">
      <div class="relative z-0 w-full mb-5">
        <Select
          ...
          type="category"
          :defautvalue="initCategory?.value"
        />
      </div>
    </div>
    <div>
    ...
    <VueSpinner
      v-if="categoryStore.isLoadingCreate"
      size="45"
      color="rgb(93, 197, 150)"
    />
    <button
      v-else
      @click="submitCreatCategory"
      type="button"
